The .vo files are compiled by CoqIDE v8.13.1, if these files do not work for your version, please delete all files except .v files and _CoqProject, and recompile them with your Coq environment.
